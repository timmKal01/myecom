<x-dashboard-layout role="seller" active="product-manage" title="Your Products">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('vendor.product') }}" class="inline-flex items-center gap-2 rounded-full bg-ink text-white text-sm font-medium px-5 py-2.5 hover:bg-accent transition-colors duration-200">
