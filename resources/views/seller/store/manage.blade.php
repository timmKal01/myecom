<x-dashboard-layout role="seller" active="store-manage" title="Your Stores">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="{{ route('vendor.store') }}" class="inline-flex items-center gap-2 rounded-full bg-ink-solid text-white text-sm font-medium px-5 py-2.5 hover:bg-accent transition-colors duration-200">
