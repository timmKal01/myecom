	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Dashboard</span>
              ...
              <i class="align-middle" data-feather="clipboard"></i> <span class="align-middle">Order</span>
            </a>
					</li>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="#" target="_blank"><strong>AdminKit</strong></a> - <a class="text-muted" href="#" target="_blank"><strong>Timothy Kalungu</strong></a>								&copy;
							</p>
						</div>
