<x-admin-layout active="reviews" title="Product Reviews">
    <div class="bg-admin-surface border border-admin-border rounded-2xl p-12 text-center">
        ...
        <h2 class="text-lg font-semibold mb-2">No review system yet</h2>
        <p class="text-sm text-admin-ink-muted max-w-sm mx-auto">
