<x-admin-layout active="carts" title="Cart Activity">
    <div class="bg-admin-surface border border-admin-border rounded-2xl p-12 text-center">
        ...
        <h2 class="text-lg font-semibold mb-2">Carts aren't persisted</h2>
        <p class="text-sm text-admin-ink-muted max-w-md mx-auto">
            ...
            <a href="{{ route('admin.order.history') }}" class="text-admin-accent font-medium hover:underline">Order History</a>.
        </p>
    </div>
</x-admin-layout>
