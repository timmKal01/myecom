<div class="space-y-2.5">
    <a
        ...
        class="group flex items-center justify-center gap-3 w-full border border-line rounded-lg py-2.5 px-4 text-sm font-medium text-ink bg-surface hover:border-ink hover:-translate-y-0.5 hover:shadow-sm transition-all duration-200"
    >
    ...
    <a
        ...
        class="group flex items-center justify-center gap-3 w-full border border-ink rounded-lg py-2.5 px-4 text-sm font-medium text-white bg-ink hover:bg-black hover:-translate-y-0.5 hover:shadow-sm transition-all duration-200"
    >
    ...
    <a
        ...
        class="group flex items-center justify-center gap-3 w-full border border-[#1877F2] rounded-lg py-2.5 px-4 text-sm font-medium text-white bg-[#1877F2] hover:bg-[#166fe0] hover:-translate-y-0.5 hover:shadow-sm transition-all duration-200"
    >
        <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<div class="flex items-center gap-3 my-6">
    ...
    <span class="text-xs text-ink-muted uppercase tracking-wider">or continue with email</span>
    <div class="flex-1 h-px bg-line"></div>
</div>
