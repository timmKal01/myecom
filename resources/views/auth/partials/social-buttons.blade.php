<div class="flex items-center justify-center gap-4">
    <a
        ...
        class="flex items-center justify-center w-11 h-11 rounded-full border border-[#dbe4e2] bg-white hover:border-[#14b8a6] hover:-translate-y-0.5 hover:shadow-md transition-all duration-200"
    >
    ...
    <a
        ...
        class="flex items-center justify-center w-11 h-11 rounded-full border border-[#dbe4e2] bg-white hover:border-[#14b8a6] hover:-translate-y-0.5 hover:shadow-md transition-all duration-200"
    >
        <svg class="w-5 h-5 text-[#1a2332]" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
