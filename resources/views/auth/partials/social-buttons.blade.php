<div class="grid grid-cols-3 gap-2.5">
    <a
        ...
        class="group flex items-center justify-center gap-2 border border-white/10 rounded-full py-2.5 px-2 text-xs font-medium text-white bg-white/5 hover:bg-white/10 hover:-translate-y-0.5 transition-all duration-200"
    >
        <svg class="w-4 h-4 shrink-0" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <a
        ...
        class="group flex items-center justify-center gap-2 border border-white/10 rounded-full py-2.5 px-2 text-xs font-medium text-white bg-white/5 hover:bg-white/10 hover:-translate-y-0.5 transition-all duration-200"
    >
        <svg class="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="#1877F2" xmlns="http://www.w3.org/2000/svg">
