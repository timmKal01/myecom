<x-guest-layout>
    <div class="auth-enter auth-enter-2">
        <h1 class="font-display text-4xl font-bold mb-2 bg-gradient-to-r from-accent to-accent-dark bg-clip-text text-transparent">
            Sign up
        </h1>
    ...
    <div class="auth-enter auth-enter-4">
        ...
        <p class="text-sm text-center text-ink-muted mt-8">
            ...
            <a href="{{ route('login') }}" class="font-semibold text-ink hover:text-accent-dark transition-colors duration-200">
                Log in
            </a>
        </p>
    </div>
