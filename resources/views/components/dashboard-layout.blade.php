@php
    $icons = [
        ...
        'card' => 'M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a1.5 1.5 0 001.5-1.5V6.75a1.5 1.5 0 00-1.5-1.5h-15a1.5 1.5 0 00-1.5 1.5v10.5a1.5 1.5 0 001.5 1.5z',
...
<body class="font-sans antialiased bg-canvas text-ink" x-data="{ sidebarOpen: false }">
    ...
    <div class="lg:flex">
        <div
            x-show="sidebarOpen"
            x-cloak
            class="fixed inset-0 z-40 bg-ink-solid/50 lg:hidden"
        ...
        <div class="flex-1 min-w-0">
            ...
            @if ($errors->any())
                <div class="bg-red-50 border-b border-red-200 text-red-700 text-sm py-3 px-8">
            ...
            <main class="px-4 sm:px-6 lg:px-8 py-8 max-w-6xl">
                {{ $slot }}
            </main>
        </div>
    </div>
